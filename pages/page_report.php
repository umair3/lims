...
<table width="100%" border="1" align="center" bordercolor="#000000">
  <caption>
    <span class="style7">Book Details    </span>
  </caption>
  <tr>
...
while($row = mysql_fetch_array($result))
  ...
  ?>
  <tr>
    <td><span class="style5"><?php echo $row['book_acc'];?></span></td>
    <td><span class="style5"><?php echo $row['book_cutt'];?></span></td>
    <td><span class="style5"><?php echo $row['book_bno'];?></span></td>
    <td><span class="style5"><?php echo $row['book_title'];?></span></td>
    <td><span class="style5"><?php echo $row['book_edition'];?></span></td>
    <td><span class="style5"><?php echo $row['book_author'];?></span></td>
    <td><span class="style5"><?php echo $row['book_subject_id'];?></span></td>
    <td><span class="style5"><?php echo $row['book_date_of_publication'];?></span></td>
    <td><span class="style5"><?php echo $row['book_publisher'];?></span></td>
    <td><span class="style5"><?php echo $row['book_language'];?></span></td>
    <td><span class="style5"><?php echo $row['book_cd_floppy'];?></span></td>
    <td><span class="style5"><?php echo $row['book_price'];?></span></td>
    <td><span class="style5"><?php echo $row['book_add_date'];?></span></td>
	<td><span class="style5"><?php echo $row['book_source'];?></span></td>
  </tr>
 <?php
 }
 ?>
